...
- `app-proxy.list`: Clash/Mihomo process rules for applications that must be forced through the proxy; currently Google Antigravity and OpenAI Codex on Windows.
